...
const Test = () => {
  return (
    <Container className="lg:max-w-4xl xl:max-w-4xl">
      <div className=" border rounded-md p-2 bg-gray-100 dark:bg-gray-900">
        <div className="relative bg-background rounded-md px-6">
          <div className="mx-auto flex flex-col items-center max-w-3xl py-16 sm:py-20">
            ...
            <p className="text-center mt-6 text-base sm:text-lg max-w-prose text-supportive">
              Welcome to QuizMedics. Get access to 1800+ questions and prepare
              for your exams with our high-yield questions. Every question on
              our platform is verified by our team to ensure our highest
              quality.
            </p>
            ...
            <div className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-3 items-center max-w-xl">
              <div className="bg-background flex flex-col gap-2 border rounded-md p-4 items-center">
                ...
                <p className="text-xs text-center text-supportive line-clamp-2">
                  Watch how your pass rate increases with our platform, most
                  users increasing their pass rate by 73% in the first two
                  weeks.
                </p>
              </div>
              <div className="bg-background flex flex-col gap-2 border rounded-md p-4 items-center">
