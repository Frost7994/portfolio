...
export const UseBoundedScrollCard = () => {
  return (
    <Card className={cn(cardWrapperStyles)}>
      <CardHeader className="space-y-0">
        <p className={cn(footerEyebrowStyles)}>Util</p>
        <h2 className={cn(footerHeaderStyles, "")}>useBoundedScroll</h2>
      </CardHeader>

      <CardFooter className="flex flex-row sm:justify-end">
        <Link
          href="/showcase/utils/use-bounded-scroll-utility"
          className={cn(
